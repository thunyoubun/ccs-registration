...
const Navbar = ({ path }: NavbarProps) => {
  ...
  return (
    <div
      className={` md:h-32 h-28 bg-white px-4 md:px-20 py-2 md:py-4 w-full fixed   top-0 z-50 shadow-md ${
      ...
      <div className=" px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex ">
          <ul className="flex gap-8">
            {path !== "/" && (
              <li className="hover:scale-105 font-semibold hover:text-teal-400 hover:drop-shadow-md transition ease-out delay-50">
                <Link href="/">Home</Link>
              </li>
            )}
            {path !== "speakers" && (
